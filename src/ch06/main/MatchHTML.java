...
import ch06.mine.LinkedStackG;
import ch06.mine.StackIntfG;
...
public class MatchHTML {
	...
	public static boolean isHTMLMatched(String html) {
		StackIntfG<String> buffer = new LinkedStackG<>();
...
//			+ "<li> And what about Naomi?      " + "\n" + "</ol>" + "\n" + "</body>";

	/**
	 * Test the text given as standard input as html. If command line argument is
	 * given, preforms test on example from the book.
	 */
	public static void main(String[] args) {
		if (args.length != 0) {
			...
			if (!isHTMLMatched(example)) {
				...
				System.out.println("Sample is valid");
			}
