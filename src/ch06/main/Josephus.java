...
public class Josephus {
  ...
  public static <E> E Josephus(CircularQueueIntfG<E> queue, int k) {
  ...
  public static <E> CircularQueueIntfG<E> buildQueue(E a[]) {
    CircularQueueIntfG<E> queue = new LinkedCircularQueueG<>();
